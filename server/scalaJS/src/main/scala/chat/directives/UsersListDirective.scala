...
@injectable("usersList")
class UsersListDirective($compile: Compile) extends ElementDirective with TemplatedDirective with IsolatedScope {

  override val templateUrl: String = "users-list-template.html"
  replace = true
